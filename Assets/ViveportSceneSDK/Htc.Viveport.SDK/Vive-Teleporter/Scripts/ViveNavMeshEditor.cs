...
public class ViveNavMeshEditor : Editor {
    ...
    public static void DewarpMesh(Vector3[] verts, NavmeshDewarpingMethod dw, float step)
    {
    ...
    public static void CullNavmeshTriangulation(Vector3[] vertices, int[] indices, int[] areas, int areaMask, bool ignore_sloped_surfaces, ref int vert_size, ref int tri_size)
    {
    ...
    public static Mesh ConvertNavmeshToMesh(Vector3[] vraw, int[] iraw, int vert_size, int tri_size)
    {
        Mesh ret = new Mesh();
    ...
    public static void RemoveMeshDuplicates(Vector3[] verts, int[] elts, out int verts_size, double threshold)
    {
